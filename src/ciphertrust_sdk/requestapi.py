...
from ciphertrust_sdk.auth import Auth, refresh_token
from ciphertrust_sdk.exceptions import CipherAPIError, CipherMissingParam, CipherPermission
from ciphertrust_sdk.static import DEFAULT_HEADERS, ENCODE
from ciphertrust_sdk.utils import reformat_exception


@refresh_token
def ctm_request(**kwargs: Dict[str, Any]) -> Dict[str, Any]:  # pylint: disable=too-many-locals
    """_summary_
